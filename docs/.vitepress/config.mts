...
export default defineConfig({
    title: "Core Tools Laravel",
    description: "",
    base: '/core-tools-laravel/',
    head: [
    ...
    themeConfig: {
        ...
        nav: [
          { text: 'Home', link: '/' },
          { text: 'Guide', link: '/v1/introduction/what-is-core-tools' },
        ],
        ...
        sidebar: [
            {
                text: 'Introduction',
                items: [
                    { text: 'What is Guidelines', link: '/v1/introduction/what-is-core-tools' },
                ]
            },
